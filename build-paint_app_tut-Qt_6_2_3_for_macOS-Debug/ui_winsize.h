...
public:
    ...
    void setupUi(QDialog *winSize)
    {
        ...
        gridLayout_2->addWidget(displayWidget, 1, 3, 3, 1);
    ...
    void retranslateUi(QDialog *winSize)
    {
        ...
        label_6->setText(QCoreApplication::translate("winSize", "Default Color:", nullptr));
